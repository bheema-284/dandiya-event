...
const friends = [
  { name: 'Vyshali G', avatar: 'https://randomuser.me/api/portraits/women/12.jpg' },
  { name: 'Bheema Guguloth', avatar: 'https://randomuser.me/api/portraits/men/1.jpg' },
  ...
  { name: 'Vikranth B', avatar: 'https://randomuser.me/api/portraits/men/4.jpg' },
  { name: 'Fiona Gallagher', avatar: 'https://randomuser.me/api/portraits/women/5.jpg' },
  { name: 'Bheemudu G', avatar: 'https://randomuser.me/api/portraits/men/6.jpg' },
  ...
  { name: 'Bheem Sagar', avatar: 'https://randomuser.me/api/portraits/men/10.jpg' },
            ...
            <div className="absolute top-full mt-2 w-full bg-white text-black rounded-lg shadow-lg max-h-64 overflow-y-auto z-50">
              {filteredFriends.length > 0 ? (
                filteredFriends.map((friend, index) => (
                  <div key={index} className="flex items-center gap-3 p-2 hover:bg-gray-100 cursor-pointer">
