    ...
    return (
        <div className="bg-white">
            ...
            <div className="relative w-full bg-white">
                ...
                <div className="relative w-full flex justify-between items-end w-full z-10">
                    <img src="/layer_9.png" className="h-10 sm:h-18 md:h-20 object-cover w-1/4" />
                    <img src="/layer_12.png" className="h-10 sm:h-18 md:h-20 object-cover w-1/4" />
                    <img src="/layer_11.png" className="h-10 sm:h-18 md:h-20 object-cover w-1/4" />
                    <img src="/layer_13.png" className="h-10 sm:h-18 md:h-20 object-cover w-1/4" />
                </div>
            </div>
        </div>
    );
